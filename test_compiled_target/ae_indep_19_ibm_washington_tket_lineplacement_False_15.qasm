...
rz(3.051757812455591e-05*pi) node[2];
...
rz(0.003906249999999556*pi) node[22];
...
sx node[5];
rz(1.0*pi) node[5];
barrier node[5],node[6],node[4],node[7],node[3],node[22],node[15],node[21],node[20],node[0],node[1],node[14],node[18],node[19],node[33],node[39],node[23],node[24],node[2];
