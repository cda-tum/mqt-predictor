...
sx node[1];
rz(0.00012207031249955591*pi) node[2];
...
cx node[4],node[1];
rz(1.5099833502745241*pi) node[1];
rz(0.5*pi) node[4];
sx node[1];
sx node[4];
rz(3.5*pi) node[1];
...
sx node[4];
rz(1.0*pi) node[4];
barrier node[4],node[1],node[7],node[0],node[2],node[10],node[6],node[12],node[13],node[14],node[11],node[8],node[5],node[3],node[9];
