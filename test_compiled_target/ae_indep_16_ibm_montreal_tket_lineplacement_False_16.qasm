...
rz(0.12499999999999956*pi) node[13];
rz(0.5*pi) node[14];
rz(0.25*pi) node[15];
...
sx node[3];
rz(1.0*pi) node[3];
barrier node[3],node[2],node[8],node[5],node[9],node[14],node[11],node[13],node[12],node[10],node[15],node[7],node[4],node[6],node[1],node[0];
