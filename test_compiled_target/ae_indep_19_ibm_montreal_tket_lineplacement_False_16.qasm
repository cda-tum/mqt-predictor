...
rz(0.001953124999999556*pi) node[12];
rz(0.015624999999999556*pi) node[13];
...
sx node[5];
rz(1.0*pi) node[5];
barrier node[5],node[3],node[8],node[2],node[1],node[4],node[7],node[10],node[12],node[15],node[18],node[21],node[6],node[0],node[13],node[14],node[11],node[16],node[9];
