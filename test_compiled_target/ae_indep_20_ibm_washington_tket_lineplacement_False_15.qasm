...
rz(3.051757812455591e-05*pi) node[1];
...
rz(0.001953124999999556*pi) node[22];
...
sx node[6];
rz(1.0*pi) node[6];
barrier node[6],node[5],node[7],node[4],node[3],node[2],node[0],node[14],node[19],node[20],node[33],node[39],node[21],node[22],node[15],node[1],node[23],node[24],node[8],node[18];
