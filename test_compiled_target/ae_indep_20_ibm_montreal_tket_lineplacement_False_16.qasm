...
rz(7.629394530805911e-06*pi) node[4];
...
rz(0.003906249999999556*pi) node[9];
rz(0.00012207031249955591*pi) node[10];
rz(0.001953124999999556*pi) node[11];
rz(0.0009765624999995559*pi) node[12];
rz(0.007812499999999556*pi) node[13];
...
sx node[18];
rz(1.0*pi) node[18];
barrier node[18],node[15],node[21],node[17],node[12],node[10],node[7],node[4],node[1],node[2],node[3],node[8],node[11],node[14],node[13],node[16],node[6],node[0],node[9],node[5];
