...
rz(0.00012207031249955591*pi) node[3];
sx node[4];
...
cx node[3],node[2];
cx node[2],node[1];
rz(2.995008324862738*pi) node[1];
cx node[2],node[1];
rz(0.5049916751372621*pi) node[1];
rz(0.5*pi) node[2];
sx node[1];
sx node[2];
rz(3.5*pi) node[1];
...
sx node[3];
rz(1.0*pi) node[3];
barrier node[3],node[2],node[4],node[19],node[20],node[18],node[21],node[14],node[0],node[22],node[15],node[5],node[6],node[1];
