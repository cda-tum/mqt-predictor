...
rz(6.103515624955591e-05*pi) node[3];
rz(3.051757812455591e-05*pi) node[4];
rz(0.0002441406249995559*pi) node[5];
...
rz(0.003906249999999556*pi) node[12];
rz(0.031249999999999556*pi) node[13];
...
sx node[12];
rz(1.0*pi) node[12];
barrier node[12],node[15],node[13],node[18],node[7],node[10],node[4],node[1],node[2],node[3],node[5],node[8],node[11],node[14],node[16],node[6],node[0],node[9];
