...
cx node[0],node[1];
rz(0.8743760406078422*pi) node[1];
cx node[0],node[1];
rz(0.5*pi) node[0];
rz(2.6256239593921578*pi) node[1];
sx node[0];
sx node[1];
rz(3.5*pi) node[0];
rz(3.5*pi) node[1];
...
sx node[14];
rz(1.0*pi) node[14];
barrier node[14],node[18],node[19],node[4],node[3],node[2],node[15],node[22],node[5],node[1],node[0];
