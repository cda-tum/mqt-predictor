...
rz(0.0004882812499995559*pi) node[5];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[1],node[4],node[0],node[7],node[10],node[6],node[12],node[15],node[13],node[18],node[14],node[11],node[8],node[5],node[9],node[2],node[3];
