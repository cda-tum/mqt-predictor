...
rz(0.5*pi) node[4];
rz(0.25*pi) node[7];
rz(0.062499999999999556*pi) node[10];
rz(0.031249999999999556*pi) node[12];
...
cx node[7],node[10];
rz(1.7487520812156845*pi) node[10];
cx node[7],node[10];
rz(0.5*pi) node[7];
rz(1.7512479187843155*pi) node[10];
sx node[7];
sx node[10];
rz(3.5*pi) node[7];
rz(3.5*pi) node[10];
...
sx node[10];
rz(1.0*pi) node[10];
barrier node[10],node[12],node[7],node[15],node[13],node[18],node[21],node[17],node[23],node[24],node[25],node[4];
