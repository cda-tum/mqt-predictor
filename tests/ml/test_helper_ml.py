...
def test_get_index_to_comppath_LUT() -> None:
    expected = {
        ...
        18: ("ionq", "ionq_harmony", "qiskit", 0),
        19: ("ionq", "ionq_harmony", "qiskit", 1),
        20: ("ionq", "ionq_harmony", "qiskit", 2),
        21: ("ionq", "ionq_harmony", "qiskit", 3),
        22: ("ionq", "ionq_harmony", "tket", False),
        23: ("ionq", "ionq_harmony", "tket", True),
        24: ("ionq", "ionq_aria1", "qiskit", 0),
        25: ("ionq", "ionq_aria1", "qiskit", 1),
        26: ("ionq", "ionq_aria1", "qiskit", 2),
        27: ("ionq", "ionq_aria1", "qiskit", 3),
        28: ("ionq", "ionq_aria1", "tket", False),
        29: ("ionq", "ionq_aria1", "tket", True),
        30: ("oqc", "oqc_lucy", "qiskit", 0),
        31: ("oqc", "oqc_lucy", "qiskit", 1),
        32: ("oqc", "oqc_lucy", "qiskit", 2),
        33: ("oqc", "oqc_lucy", "qiskit", 3),
        34: ("oqc", "oqc_lucy", "tket", False),
        35: ("oqc", "oqc_lucy", "tket", True),
        36: ("quantinuum", "quantinuum_h2", "qiskit", 0),
        37: ("quantinuum", "quantinuum_h2", "qiskit", 1),
        38: ("quantinuum", "quantinuum_h2", "qiskit", 2),
        39: ("quantinuum", "quantinuum_h2", "qiskit", 3),
        40: ("quantinuum", "quantinuum_h2", "tket", False),
        41: ("quantinuum", "quantinuum_h2", "tket", True),
    }
