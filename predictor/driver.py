...
def predict(input):
    # check if trained model exist; if not: print error message and abort
    # consider qiskit qc, tket qc, qasm string and qasm file path as valid input
    # Predict best comp flow and return it
    pass
