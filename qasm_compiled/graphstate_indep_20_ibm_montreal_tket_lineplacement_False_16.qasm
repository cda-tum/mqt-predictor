...
sx node[12];
rz(1.5*pi) node[12];
barrier node[4],node[5],node[14],node[11],node[0],node[7],node[10],node[9],node[8],node[22],node[19],node[15],node[1],node[25],node[24],node[2],node[13],node[12],node[16],node[3];
