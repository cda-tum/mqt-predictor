...
sx node[125];
rz(1.5*pi) node[125];
barrier node[83],node[86],node[87],node[111],node[84],node[92],node[119],node[120],node[123],node[124],node[110],node[100],node[106],node[104],node[112],node[126],node[102],node[107],node[125],node[105],node[101],node[121],node[103],node[108],node[93],node[122],node[118];
