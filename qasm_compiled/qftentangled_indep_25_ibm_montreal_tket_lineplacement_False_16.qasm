...
rz(0.49609375000000044*pi) node[10];
cx node[1],node[4];
cx node[8],node[5];
cx node[2],node[1];
cx node[7],node[4];
...
sx node[7];
cx node[0],node[1];
rz(0.48437500000000044*pi) node[7];
cx node[1],node[0];
cx node[10],node[7];
cx node[0],node[1];
cx node[7],node[10];
...
cx node[1],node[4];
cx node[3],node[5];
rz(0.46875000000000044*pi) node[10];
cx node[5],node[3];
rz(0.015625*pi) node[4];
cx node[12],node[10];
cx node[2],node[3];
...
cx node[1],node[0];
cx node[7],node[4];
rz(0.43750000000000044*pi) node[10];
rz(0.015625*pi) node[0];
cx node[1],node[2];
rz(0.0625*pi) node[4];
cx node[12],node[10];
...
sx node[10];
rz(1.0*pi) node[10];
barrier node[19],node[22],node[25],node[23],node[24],node[21],node[17],node[18],node[6],node[15],node[13],node[9],node[16],node[14],node[11],node[8],node[5],node[3],node[0],node[2],node[1],node[4],node[12],node[7],node[10];
