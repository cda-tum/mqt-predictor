...
sx node[10];
rz(1.5*pi) node[10];
barrier node[2],node[0],node[1],node[15],node[12],node[19],node[16],node[8],node[11],node[6],node[4],node[21],node[23],node[7],node[14],node[10],node[5],node[24],node[18],node[22],node[25],node[3];
