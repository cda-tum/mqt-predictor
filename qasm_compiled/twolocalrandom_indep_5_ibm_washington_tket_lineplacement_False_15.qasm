...
rz(0.5*pi) node[3];
sx node[14];
rz(3.2235365105327363*pi) node[0];
rz(3.2879466542784512*pi) node[1];
rz(3.212796000817804*pi) node[2];
sx node[3];
rz(3.104357078336898*pi) node[14];
sx node[0];
sx node[1];
sx node[2];
rz(3.5*pi) node[3];
...
sx node[14];
cx node[2],node[1];
rz(3.2360573636040506*pi) node[14];
cx node[1],node[2];
sx node[14];
cx node[3],node[2];
rz(1.0*pi) node[14];
...
sx node[0];
cx node[1],node[2];
rz(3.3065191824673295*pi) node[0];
cx node[2],node[1];
sx node[0];
cx node[1],node[2];
rz(1.0*pi) node[0];
...
cx node[1],node[0];
sx node[1];
rz(3.1315783488598363*pi) node[1];
sx node[1];
rz(1.0*pi) node[1];
cx node[0],node[1];
cx node[1],node[0];
