...
sx node[15];
cx node[23],node[24];
rz(0.49999994039535567*pi) node[15];
cx node[24],node[25];
cx node[15],node[18];
cx node[25],node[22];
rz(3.75*pi) node[18];
...
rz(3.7550926208496094e-06*pi) node[11];
cx node[14],node[13];
rz(3.875*pi) node[18];
...
sx node[18];
rz(1.0*pi) node[18];
barrier node[0],node[10],node[7],node[9],node[4],node[20],node[3],node[2],node[1],node[5],node[8],node[12],node[11],node[25],node[13],node[14],node[16],node[19],node[22],node[24],node[23],node[15],node[21],node[18];
