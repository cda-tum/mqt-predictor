...
sx node[22];
sx node[24];
rz(1.0714025793170423*pi) node[25];
sx node[26];
sx node[1];
sx node[2];
sx node[4];
...
rz(0.5*pi) node[1];
rz(0.5*pi) node[2];
rz(2.3524163823495665*pi) node[4];
sx node[5];
rz(2.0779791303773694*pi) node[6];
sx node[8];
sx node[9];
sx node[11];
rz(3.5*pi) node[12];
sx node[13];
sx node[14];
rz(2.6211189415908436*pi) node[15];
sx node[16];
sx node[19];
sx node[20];
sx node[21];
...
rz(0.5*pi) node[15];
cx node[25],node[24];
rz(0.9285974180839212*pi) node[24];
x node[24];
rz(0.5*pi) node[24];
cx node[25],node[24];
cx node[25],node[22];
rz(3.571402641520723*pi) node[24];
rz(0.35719484049360795*pi) node[22];
x node[22];
rz(0.5*pi) node[22];
cx node[25],node[22];
rz(2.1428052787156813*pi) node[22];
cx node[25],node[26];
rz(0.2143896746210181*pi) node[26];
x node[26];
rz(0.5*pi) node[26];
cx node[25],node[26];
cx node[25],node[22];
rz(2.2856105637975603*pi) node[26];
cx node[22],node[25];
cx node[25],node[22];
cx node[22],node[19];
cx node[26],node[25];
rz(0.9287793640148638*pi) node[19];
cx node[25],node[26];
x node[19];
cx node[26],node[25];
rz(0.5*pi) node[19];
cx node[22],node[19];
rz(1.5712211128222937*pi) node[19];
cx node[22],node[19];
cx node[19],node[22];
cx node[22],node[19];
cx node[19],node[16];
rz(0.35755872758084495*pi) node[16];
x node[16];
rz(0.5*pi) node[16];
cx node[19],node[16];
rz(2.142442226093471*pi) node[16];
cx node[19],node[20];
rz(0.2151174583447888*pi) node[20];
x node[20];
rz(0.5*pi) node[20];
cx node[19],node[20];
cx node[19],node[16];
rz(2.2848844490038434*pi) node[20];
cx node[16],node[19];
cx node[19],node[16];
cx node[16],node[14];
cx node[20],node[19];
...
rz(0.5*pi) node[14];
cx node[16],node[14];
rz(1.5697688991503544*pi) node[14];
cx node[16],node[14];
cx node[14],node[16];
cx node[16],node[14];
cx node[14],node[11];
rz(0.3604698179125433*pi) node[11];
x node[11];
rz(0.5*pi) node[11];
cx node[14],node[11];
rz(2.1395378114819876*pi) node[11];
cx node[14],node[13];
rz(0.2209396326419878*pi) node[13];
x node[13];
rz(0.5*pi) node[13];
cx node[14],node[13];
cx node[14],node[11];
rz(2.2790756261470744*pi) node[13];
cx node[11],node[14];
cx node[14],node[11];
cx node[11],node[8];
rz(0.9418792800568032*pi) node[8];
x node[8];
rz(0.5*pi) node[8];
cx node[11],node[8];
rz(1.5581512375213213*pi) node[8];
cx node[11],node[8];
cx node[8],node[11];
cx node[11],node[8];
cx node[8],node[5];
rz(0.3837585453407789*pi) node[5];
x node[5];
rz(0.5*pi) node[5];
cx node[8],node[5];
rz(2.1163024898154705*pi) node[5];
cx node[8],node[9];
rz(0.2675170906815578*pi) node[9];
x node[9];
rz(0.5*pi) node[9];
cx node[8],node[9];
rz(0.5*pi) node[8];
rz(2.2326049796309415*pi) node[9];
sx node[8];
rz(3.5*pi) node[8];
sx node[8];
rz(1.0*pi) node[8];
...
sx node[5];
cx node[9],node[8];
rz(0.4649658186368846*pi) node[5];
sx node[5];
rz(2.5*pi) node[5];
cx node[5],node[3];
sx node[3];
...
rz(3.5*pi) node[3];
sx node[3];
rz(0.46520995926188313*pi) node[3];
cx node[5],node[3];
cx node[3],node[5];
cx node[5],node[3];
cx node[3],node[2];
rz(0.5*pi) node[3];
sx node[3];
rz(1.9299316400079851*pi) node[3];
sx node[3];
rz(2.5*pi) node[3];
cx node[3],node[2];
sx node[2];
rz(3.5*pi) node[2];
sx node[2];
rz(1.4304199212579845*pi) node[2];
cx node[3],node[2];
cx node[2],node[3];
cx node[3],node[2];
cx node[2],node[1];
rz(0.5*pi) node[2];
sx node[2];
rz(1.8598632816075185*pi) node[2];
sx node[2];
rz(1.5*pi) node[2];
cx node[2],node[1];
sx node[1];
...
rz(3.5*pi) node[1];
sx node[1];
rz(1.3608398441075185*pi) node[1];
cx node[2],node[1];
cx node[1],node[2];
cx node[2],node[1];
cx node[1],node[0];
...
sx node[0];
sx node[1];
rz(1.721679694581235*pi) node[0];
rz(1.5*pi) node[1];
cx node[1],node[4];
rz(0.5*pi) node[1];
sx node[1];
...
sx node[18];
rz(1.0*pi) node[18];
barrier node[1],node[9],node[2],node[20],node[26],node[3],node[24],node[25],node[22],node[19],node[16],node[11],node[5],node[8],node[14],node[13],node[4],node[6],node[7],node[10],node[12],node[21],node[15],node[18],node[0];
measure node[1] -> c[0];
measure node[9] -> c[1];
measure node[2] -> c[2];
measure node[20] -> c[3];
