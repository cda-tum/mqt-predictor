...
rz(0.5*pi) node[22];
sx node[22];
rz(0.48437500000000044*pi) node[22];
cx node[19],node[22];
cx node[22],node[19];
cx node[19],node[22];
cx node[22],node[25];
...
sx node[22];
cx node[24],node[25];
rz(0.46875000000000044*pi) node[22];
cx node[24],node[23];
cx node[19],node[22];
...
cx node[24],node[25];
cx node[18],node[21];
rz(0.43750000000000044*pi) node[22];
cx node[24],node[23];
cx node[21],node[18];
cx node[19],node[22];
rz(3.96875*pi) node[23];
...
sx node[22];
cx node[24],node[25];
rz(0.37500000000000044*pi) node[22];
cx node[24],node[23];
cx node[19],node[22];
rz(3.96875*pi) node[23];
cx node[22],node[19];
...
sx node[22];
rz(1.0*pi) node[22];
barrier node[18],node[21],node[23],node[24],node[19],node[25],node[22];
