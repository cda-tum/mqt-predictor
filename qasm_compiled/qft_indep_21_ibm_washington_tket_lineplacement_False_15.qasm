...
sx node[0];
rz(1.0*pi) node[0];
barrier node[16],node[8],node[7],node[26],node[24],node[33],node[19],node[20],node[21],node[23],node[22],node[1],node[2],node[3],node[4],node[6],node[5],node[15],node[18],node[14],node[0];
