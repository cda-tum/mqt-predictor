...
cx node[12],node[15];
rz(3.984375*pi) node[2];
rz(0.49998474121093794*pi) node[4];
cx node[7],node[10];
cx node[15],node[12];
cx node[3],node[2];
cx node[6],node[7];
...
sx node[2];
rz(1.0*pi) node[2];
barrier node[9],node[21],node[17],node[0],node[24],node[25],node[5],node[20],node[22],node[19],node[8],node[11],node[16],node[14],node[13],node[18],node[15],node[12],node[6],node[10],node[7],node[4],node[3],node[1],node[2];
