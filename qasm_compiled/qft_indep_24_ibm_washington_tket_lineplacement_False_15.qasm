...
cx node[3],node[4];
rz(0.48437500000000044*pi) node[14];
cx node[22],node[15];
cx node[4],node[3];
cx node[18],node[14];
cx node[15],node[22];
...
rz(0.46875000000000044*pi) node[14];
cx node[5],node[4];
cx node[18],node[14];
cx node[4],node[5];
cx node[14],node[18];
...
cx node[1],node[2];
rz(3.99951171875*pi) node[5];
rz(0.43750000000000044*pi) node[14];
rz(3.96875*pi) node[2];
cx node[6],node[5];
cx node[18],node[14];
cx node[1],node[2];
...
sx node[0];
rz(1.0*pi) node[0];
barrier node[16],node[8],node[7],node[26],node[25],node[43],node[34],node[24],node[33],node[23],node[19],node[20],node[21],node[6],node[5],node[22],node[15],node[4],node[3],node[2],node[18],node[1],node[14],node[0];
