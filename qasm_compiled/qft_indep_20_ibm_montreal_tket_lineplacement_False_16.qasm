...
sx node[1];
rz(1.0*pi) node[1];
barrier node[9],node[21],node[17],node[18],node[15],node[7],node[4],node[6],node[10],node[13],node[12],node[16],node[14],node[11],node[8],node[5],node[2],node[3],node[0],node[1];
