...
sx node[124];
rz(1.5*pi) node[124];
barrier node[100],node[82],node[85],node[87],node[106],node[81],node[120],node[119],node[123],node[98],node[110],node[84],node[86],node[99],node[101],node[93],node[105],node[112],node[108],node[107],node[80],node[92],node[121],node[103],node[111],node[126],node[125],node[83],node[104],node[122],node[102],node[118],node[124];
