...
sx node[1];
rz(1.0*pi) node[1];
barrier node[24],node[7],node[8],node[43],node[16],node[34],node[26],node[25],node[15],node[6],node[5],node[4],node[23],node[22],node[21],node[20],node[19],node[18],node[14],node[3],node[0],node[2],node[1];
