...
sx node[22];
rz(1.5*pi) node[22];
barrier node[3],node[5],node[16],node[4],node[10],node[7],node[25],node[18],node[15],node[24],node[21],node[8],node[23],node[14],node[19],node[12],node[11],node[13],node[22];
