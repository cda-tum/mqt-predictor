...
rz(3.051757812455591e-05*pi) node[4];
rz(0.001953124999999556*pi) node[5];
rz(6.103515624955591e-05*pi) node[6];
rz(1.525878906205591e-05*pi) node[7];
rz(0.003906249999999556*pi) node[8];
rz(0.015624999999999556*pi) node[9];
rz(3.814697265180911e-06*pi) node[10];
rz(0.007812499999999556*pi) node[11];
rz(1.9073486323684108e-06*pi) node[12];
rz(7.629394530805911e-06*pi) node[13];
rz(0.031249999999999556*pi) node[14];
rz(4.768371577590358e-07*pi) node[15];
rz(0.062499999999999556*pi) node[16];
rz(9.536743159621608e-07*pi) node[17];
...
cx node[0],node[1];
cx node[3],node[2];
rz(3.9999924898147583*pi) node[11];
rz(3.96875*pi) node[12];
cx node[1],node[0];
rz(0.0001220703125*pi) node[2];
cx node[8],node[11];
...
cx node[7],node[6];
cx node[10],node[12];
rz(3.999993324279785*pi) node[21];
cx node[1],node[2];
rz(0.25*pi) node[6];
cx node[12],node[10];
cx node[2],node[3];
...
sx node[18];
rz(1.0*pi) node[18];
barrier node[18],node[15],node[21],node[12],node[14],node[11],node[16],node[8],node[5],node[3],node[2],node[1],node[4],node[7],node[10],node[13],node[19],node[25],node[24],node[23],node[6],node[17],node[0],node[9],node[20],node[22];
