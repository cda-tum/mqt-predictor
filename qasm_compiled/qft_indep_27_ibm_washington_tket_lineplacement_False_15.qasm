...
sx node[14];
cx node[3],node[2];
rz(0.49609375000000044*pi) node[14];
cx node[2],node[3];
cx node[18],node[14];
cx node[3],node[4];
cx node[14],node[18];
...
sx node[5];
rz(1.0*pi) node[5];
barrier node[16],node[8],node[7],node[27],node[26],node[42],node[44],node[43],node[25],node[34],node[24],node[23],node[22],node[33],node[21],node[20],node[19],node[18],node[14],node[0],node[1],node[2],node[15],node[3],node[6],node[4],node[5];
