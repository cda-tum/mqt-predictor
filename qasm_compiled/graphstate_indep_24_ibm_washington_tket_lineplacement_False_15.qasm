...
sx node[4];
rz(1.5*pi) node[4];
barrier node[1],node[0],node[19],node[21],node[7],node[15],node[6],node[9],node[11],node[22],node[2],node[10],node[16],node[17],node[12],node[26],node[18],node[14],node[25],node[8],node[3],node[5],node[4],node[20];
