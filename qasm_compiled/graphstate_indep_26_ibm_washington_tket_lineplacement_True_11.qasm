...
sx node[93];
rz(1.5*pi) node[93];
barrier node[107],node[84],node[108],node[126],node[122],node[111],node[110],node[100],node[118],node[83],node[87],node[102],node[119],node[103],node[104],node[112],node[106],node[105],node[93],node[123],node[125],node[120],node[101],node[92],node[124],node[121];
