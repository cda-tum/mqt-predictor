...
cx node[12],node[15];
rz(3.984375*pi) node[2];
rz(0.49996948242187544*pi) node[4];
cx node[7],node[10];
cx node[15],node[12];
cx node[3],node[2];
cx node[6],node[7];
...
sx node[3];
rz(1.0*pi) node[3];
barrier node[9],node[21],node[17],node[0],node[25],node[22],node[1],node[20],node[19],node[16],node[6],node[4],node[7],node[18],node[15],node[10],node[12],node[13],node[14],node[11],node[8],node[2],node[5],node[3];
