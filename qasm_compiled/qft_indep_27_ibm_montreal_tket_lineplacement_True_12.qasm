...
rz(3.5762786865234375e-06*pi) node[14];
rz(3.6954879760742188e-06*pi) node[16];
rz(3.7550926208496094e-06*pi) node[19];
rz(3.7997961044311523e-06*pi) node[20];
rz(3.7848949432373047e-06*pi) node[22];
sx node[24];
rz(3.807246685028076e-06*pi) node[26];
rz(0.5*pi) node[24];
sx node[24];
rz(0.49999999254941985*pi) node[24];
cx node[24],node[25];
rz(3.75*pi) node[25];
cx node[24],node[25];
cx node[24],node[23];
...
sx node[25];
cx node[24],node[23];
rz(0.49999998509883925*pi) node[25];
cx node[23],node[24];
cx node[24],node[23];
cx node[23],node[21];
cx node[25],node[24];
...
sx node[24];
cx node[21],node[18];
rz(0.49999997019767806*pi) node[24];
...
cx node[15],node[12];
cx node[21],node[18];
rz(0.49999994039535567*pi) node[24];
...
rz(3.99609375*pi) node[12];
cx node[18],node[17];
rz(0.4999998807907109*pi) node[24];
cx node[7],node[10];
cx node[15],node[12];
cx node[17],node[18];
cx node[25],node[24];
...
cx node[13],node[12];
cx node[18],node[15];
rz(0.49999976158142134*pi) node[24];
cx node[1],node[0];
rz(0.00048828125*pi) node[7];
cx node[15],node[12];
cx node[17],node[18];
...
cx node[18],node[15];
cx node[21],node[23];
rz(0.49999904632568404*pi) node[24];
cx node[4],node[1];
cx node[2],node[3];
cx node[6],node[7];
cx node[12],node[10];
...
sx node[24];
rz(1.0*pi) node[24];
barrier node[26],node[9],node[20],node[22],node[19],node[16],node[14],node[11],node[8],node[5],node[3],node[0],node[2],node[1],node[6],node[4],node[7],node[13],node[10],node[12],node[17],node[15],node[18],node[21],node[25],node[23],node[24];
