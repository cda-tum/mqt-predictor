...
rz(9.536743159621608e-07*pi) node[3];
rz(4.768371577590358e-07*pi) node[4];
rz(3.814697265180911e-06*pi) node[5];
rz(1.525878906205591e-05*pi) node[6];
rz(1.9073486323684108e-06*pi) node[7];
rz(3.051757812455591e-05*pi) node[8];
rz(0.0002441406249995559*pi) node[9];
rz(7.629394530805911e-06*pi) node[10];
rz(0.00012207031249955591*pi) node[11];
rz(6.103515624955591e-05*pi) node[12];
rz(0.0004882812499995559*pi) node[13];
rz(0.001953124999999556*pi) node[14];
rz(0.0009765624999995559*pi) node[15];
rz(0.007812499999999556*pi) node[16];
rz(0.031249999999999556*pi) node[17];
...
cx node[7],node[4];
cx node[4],node[1];
rz(2.897691984195262*pi) node[1];
cx node[4],node[1];
rz(0.6023080158047378*pi) node[1];
rz(0.5*pi) node[4];
sx node[1];
sx node[4];
rz(3.5*pi) node[1];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[1],node[0],node[7],node[4],node[10],node[12],node[15],node[14],node[13],node[11],node[8],node[9],node[16],node[18],node[21],node[19],node[17],node[5],node[22],node[25],node[3],node[6],node[24],node[2];
