...
rz(1.0*pi) q[3];
rz(3.5*pi) psi[0];
rx(0.011746484727999718*pi) q[3];
rx(3.4240070476237747*pi) psi[0];
rz(1.0*pi) q[3];
ry(0.5*pi) psi[0];
ry(0.5*pi) q[3];
...
rz(1.0*pi) q[4];
rz(3.5*pi) psi[0];
rx(0.6568369072601293*pi) q[4];
rx(0.8475237120755355*pi) psi[0];
rz(1.0*pi) q[4];
ry(0.5*pi) psi[0];
ry(0.5*pi) q[4];
