...
cx node[12],node[10];
cx node[14],node[11];
rz(0.49609375000000044*pi) node[4];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[9],node[21],node[8],node[18],node[6],node[7],node[16],node[15],node[10],node[12],node[13],node[14],node[11],node[5],node[3],node[0],node[4],node[2],node[1];
