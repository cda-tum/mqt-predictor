...
sx node[125];
rz(1.5*pi) node[125];
barrier node[123],node[75],node[81],node[83],node[93],node[105],node[103],node[111],node[77],node[91],node[87],node[79],node[82],node[126],node[124],node[80],node[78],node[122],node[101],node[106],node[112],node[125],node[119],node[118],node[108],node[121],node[97],node[92],node[90],node[86],node[96],node[110],node[99],node[102],node[85],node[100],node[120],node[107],node[98],node[104],node[84],node[95],node[94];
