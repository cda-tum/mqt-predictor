...
cx node[3],node[2];
cx node[1],node[2];
barrier node[2],node[1],node[0],node[3],node[4],node[7],node[10],node[12],node[13],node[14],node[16],node[19],node[22],node[25],node[24],node[23],node[21],node[18],node[15];
