...
sx node[1];
rz(1.0*pi) node[1];
barrier node[26],node[16],node[8],node[7],node[6],node[3],node[5],node[4],node[23],node[15],node[22],node[33],node[21],node[20],node[19],node[18],node[14],node[2],node[0],node[1];
