...
sx node[14];
rz(1.0*pi) node[14];
barrier node[124],node[125],node[123],node[122],node[121],node[111],node[104],node[105],node[103],node[102],node[101],node[92],node[83],node[84],node[82],node[81],node[80],node[72],node[62],node[63],node[61],node[58],node[71],node[59],node[54],node[46],node[45],node[56],node[57],node[52],node[34],node[29],node[35],node[28],node[44],node[16],node[15],node[8],node[7],node[6],node[5],node[27],node[4],node[26],node[3],node[37],node[2],node[25],node[60],node[38],node[1],node[24],node[43],node[42],node[23],node[53],node[41],node[22],node[21],node[40],node[39],node[33],node[20],node[19],node[18],node[14],node[0];
