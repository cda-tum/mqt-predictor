...
sx node[106];
rz(1.5*pi) node[106];
barrier node[108],node[79],node[98],node[101],node[104],node[93],node[84],node[87],node[82],node[92],node[86],node[85],node[103],node[102],node[83],node[121],node[120],node[126],node[125],node[107],node[91],node[96],node[112],node[111],node[80],node[105],node[106],node[123],node[122],node[100],node[110],node[99],node[118],node[119],node[124],node[81],node[97];
