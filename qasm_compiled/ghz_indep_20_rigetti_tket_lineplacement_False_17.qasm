...
rx(0.5*pi) node[10];
rz(0.5*pi) node[10];
barrier node[10],node[9],node[8],node[15],node[14],node[13],node[12],node[55],node[54],node[41],node[40],node[4],node[5],node[7],node[0],node[1],node[2],node[3],node[47],node[6];
