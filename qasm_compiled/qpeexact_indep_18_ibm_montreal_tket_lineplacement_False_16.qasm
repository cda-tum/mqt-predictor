...
sx node[8];
sx node[10];
rz(1.7998479256383124*pi) node[11];
sx node[12];
rz(0.5*pi) node[15];
cx node[1],node[0];
sx node[11];
sx node[15];
rz(0.4286041185070254*pi) node[0];
rz(0.5*pi) node[11];
rz(0.5*pi) node[15];
cx node[1],node[0];
rz(3.5714035108875053*pi) node[0];
cx node[1],node[2];
rz(3.857208252480662*pi) node[2];
cx node[1],node[2];
cx node[1],node[4];
rz(2.1428070063084*pi) node[2];
cx node[3],node[2];
rz(3.7144165081444234*pi) node[4];
cx node[1],node[4];
cx node[2],node[3];
cx node[3],node[2];
rz(2.285614009433701*pi) node[4];
cx node[1],node[2];
cx node[5],node[3];
cx node[7],node[4];
...
cx node[10],node[7];
cx node[3],node[2];
rz(3.8576660155195324*pi) node[4];
cx node[5],node[8];
cx node[7],node[10];
cx node[1],node[4];
cx node[2],node[3];
...
cx node[10],node[7];
cx node[3],node[2];
rz(2.142456054792967*pi) node[4];
cx node[11],node[8];
cx node[12],node[10];
cx node[1],node[2];
cx node[5],node[3];
...
cx node[8],node[11];
cx node[10],node[12];
rz(3.715332031039065*pi) node[2];
cx node[3],node[5];
cx node[4],node[7];
cx node[11],node[8];
cx node[12],node[10];
...
cx node[13],node[12];
cx node[1],node[4];
rz(2.2849121095859344*pi) node[2];
cx node[8],node[5];
cx node[6],node[7];
cx node[12],node[13];
cx node[3],node[2];
rz(0.4306640609354637*pi) node[4];
cx node[5],node[8];
cx node[7],node[6];
cx node[13],node[12];
cx node[1],node[4];
...
cx node[14],node[13];
cx node[3],node[2];
rz(1.5698242203145356*pi) node[4];
cx node[9],node[8];
cx node[13],node[14];
cx node[5],node[3];
cx node[7],node[4];
...
cx node[10],node[7];
cx node[16],node[14];
rz(3.8613281246051434*pi) node[4];
cx node[5],node[8];
cx node[7],node[10];
cx node[1],node[4];
cx node[8],node[5];
cx node[10],node[7];
cx node[1],node[2];
rz(2.139648437894856*pi) node[4];
cx node[12],node[10];
...
cx node[4],node[7];
cx node[12],node[10];
rz(0.2792968789728112*pi) node[2];
cx node[7],node[4];
cx node[15],node[12];
cx node[1],node[4];
cx node[3],node[2];
...
cx node[12],node[15];
cx node[2],node[3];
rz(0.44531250682720436*pi) node[4];
cx node[7],node[10];
cx node[15],node[12];
cx node[1],node[4];
cx node[3],node[2];
...
cx node[5],node[3];
rz(3.5546874931727954*pi) node[4];
cx node[12],node[10];
cx node[15],node[18];
sx node[1];
cx node[3],node[5];
...
rz(2.5*pi) node[4];
sx node[4];
rz(1.9687499999999996*pi) node[4];
cx node[7],node[4];
cx node[4],node[7];
cx node[7],node[4];
cx node[1],node[4];
...
cx node[13],node[12];
sx node[4];
rz(1.4374999999999993*pi) node[4];
cx node[7],node[4];
cx node[4],node[7];
cx node[7],node[4];
cx node[1],node[4];
...
rz(3.5*pi) node[4];
sx node[4];
rz(0.8749999999999991*pi) node[4];
cx node[7],node[4];
cx node[4],node[7];
cx node[7],node[4];
cx node[1],node[4];
...
sx node[10];
cx node[7],node[4];
rz(0.003906249999999556*pi) node[10];
cx node[4],node[7];
cx node[7],node[4];
cx node[1],node[4];
cx node[10],node[7];
...
sx node[12];
rz(1.0*pi) node[12];
barrier node[0],node[6],node[16],node[14],node[11],node[8],node[5],node[3],node[2],node[1],node[4],node[10],node[7],node[18],node[13],node[15],node[12],node[9];
measure node[0] -> c[0];
measure node[6] -> c[1];
measure node[16] -> c[2];
measure node[14] -> c[3];
