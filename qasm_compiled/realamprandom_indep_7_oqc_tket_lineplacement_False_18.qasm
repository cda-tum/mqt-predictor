...
sx node[6];
sx node[7];
rz(1.2019292746062282*pi) node[0];
rz(3.1263859945362285*pi) node[1];
rz(3.2559231362729135*pi) node[2];
rz(3.292434936364968*pi) node[3];
rz(3.1716981891687728*pi) node[4];
sx node[5];
rz(3.0578808188374946*pi) node[7];
sx node[0];
sx node[1];
sx node[2];
sx node[3];
...
x node[1];
ecr node[2],node[3];
rz(1.032780263259121*pi) node[4];
rz(3.5*pi) node[5];
rz(3.5*pi) node[1];
sx node[2];
x node[3];
...
rz(3.5*pi) node[2];
ecr node[3],node[4];
rz(3.049894663664375*pi) node[7];
ecr node[2],node[1];
sx node[3];
x node[4];
sx node[7];
...
ecr node[3],node[4];
x node[7];
rz(1.2738499597676216*pi) node[0];
ecr node[2],node[1];
sx node[3];
x node[4];
rz(3.5*pi) node[7];
...
rz(3.5*pi) node[4];
x node[7];
rz(3.150549519677187*pi) node[2];
ecr node[4],node[3];
rz(3.5*pi) node[7];
ecr node[7],node[0];
sx node[2];
...
rz(3.5*pi) node[0];
rz(3.5*pi) node[2];
rz(3.3006741348091237*pi) node[4];
ecr node[0],node[7];
ecr node[2],node[1];
sx node[4];
sx node[0];
...
sx node[5];
rz(3.5*pi) node[4];
rz(3.2167082488266523*pi) node[5];
ecr node[4],node[3];
sx node[5];
x node[3];
sx node[4];
