...
sx node[126];
rz(0.25*pi) node[103];
rz(0.12499999999999956*pi) node[104];
rz(0.5*pi) node[105];
rz(0.031249999999999556*pi) node[111];
rz(0.062499999999999556*pi) node[121];
rz(0.015624999999999556*pi) node[122];
rz(0.007812499999999556*pi) node[123];
rz(0.001953124999999556*pi) node[124];
sx node[125];
rz(0.003906249999999556*pi) node[126];
...
rz(0.43718642875448666*pi) node[104];
cx node[105],node[104];
rz(3.0628135712455133*pi) node[104];
rz(0.5*pi) node[105];
sx node[104];
sx node[105];
rz(3.5*pi) node[104];
...
cx node[111],node[104];
rz(0.015625*pi) node[122];
rz(0.001953125*pi) node[125];
cx node[104],node[111];
cx node[123],node[122];
cx node[126],node[125];
cx node[111],node[104];
rz(3.984375*pi) node[122];
rz(3.998046875*pi) node[125];
cx node[104],node[103];
cx node[122],node[123];
cx node[126],node[125];
rz(0.25*pi) node[103];
...
sx node[104];
rz(1.0*pi) node[104];
barrier node[104],node[111],node[103],node[122],node[123],node[121],node[124],node[125],node[126],node[105];
