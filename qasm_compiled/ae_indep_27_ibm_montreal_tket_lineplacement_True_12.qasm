...
rz(1.525878906205591e-05*pi) node[4];
rz(0.0009765624999995559*pi) node[5];
rz(3.051757812455591e-05*pi) node[6];
rz(7.629394530805911e-06*pi) node[7];
rz(0.001953124999999556*pi) node[8];
rz(0.007812499999999556*pi) node[9];
rz(1.9073486323684108e-06*pi) node[10];
rz(0.003906249999999556*pi) node[11];
rz(9.536743159621608e-07*pi) node[12];
rz(3.814697265180911e-06*pi) node[13];
rz(0.015624999999999556*pi) node[14];
rz(2.384185786574733e-07*pi) node[15];
rz(0.031249999999999556*pi) node[16];
rz(4.768371577590358e-07*pi) node[17];
...
cx node[8],node[9];
cx node[12],node[13];
rz(0.000244140625*pi) node[9];
cx node[14],node[13];
cx node[8],node[9];
cx node[13],node[14];
rz(3.999755859375*pi) node[9];
cx node[14],node[13];
cx node[9],node[8];
cx node[8],node[9];
cx node[9],node[8];
...
cx node[10],node[7];
cx node[11],node[14];
rz(3.9999924302101135*pi) node[12];
cx node[20],node[19];
cx node[3],node[2];
...
cx node[15],node[12];
cx node[11],node[8];
rz(3.9999924898147583*pi) node[12];
cx node[8],node[11];
cx node[15],node[12];
cx node[9],node[8];
cx node[14],node[11];
...
cx node[3],node[2];
cx node[6],node[7];
rz(3.999992609024048*pi) node[12];
cx node[13],node[14];
cx node[4],node[1];
cx node[2],node[3];
rz(0.5*pi) node[6];
...
sx node[7];
rz(1.0*pi) node[7];
barrier node[7],node[6],node[4],node[12],node[10],node[13],node[11],node[19],node[22],node[8],node[16],node[2],node[9],node[1],node[3],node[5],node[25],node[20],node[23],node[18],node[15],node[14],node[21],node[17],node[26],node[24],node[0];
