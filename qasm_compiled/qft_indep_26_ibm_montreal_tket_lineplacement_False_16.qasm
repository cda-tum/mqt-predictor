...
cx node[8],node[11];
rz(3.9375*pi) node[2];
rz(0.4999998807907109*pi) node[4];
rz(0.015625*pi) node[5];
cx node[8],node[9];
...
rz(3.9375*pi) node[2];
cx node[3],node[5];
rz(0.49999809265136763*pi) node[4];
cx node[7],node[10];
cx node[9],node[8];
cx node[11],node[14];
cx node[15],node[12];
...
cx node[12],node[15];
rz(3.984375*pi) node[2];
rz(0.4999923706054692*pi) node[4];
cx node[7],node[10];
cx node[15],node[12];
cx node[3],node[2];
cx node[6],node[7];
...
sx node[2];
rz(1.0*pi) node[2];
barrier node[9],node[21],node[17],node[0],node[24],node[26],node[5],node[20],node[25],node[22],node[19],node[8],node[11],node[6],node[16],node[14],node[18],node[13],node[15],node[12],node[10],node[7],node[4],node[3],node[1],node[2];
