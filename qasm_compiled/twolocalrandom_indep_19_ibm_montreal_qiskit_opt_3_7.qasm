...
rz(2.3481824) q[24];
sx q[24];
barrier q[21],q[24],q[23],q[15],q[22],q[17],q[20],q[26],q[8],q[12],q[16],q[13],q[19],q[14],q[1],q[25],q[3],q[5],q[0],q[18],q[6],q[11],q[9],q[7],q[4],q[10],q[2];
measure q[5] -> meas[0];
measure q[3] -> meas[1];
measure q[2] -> meas[2];
measure q[1] -> meas[3];
