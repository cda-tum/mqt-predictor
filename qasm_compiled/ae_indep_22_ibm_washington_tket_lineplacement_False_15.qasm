...
rz(0.007812499999999556*pi) node[23];
rz(0.062499999999999556*pi) node[24];
...
sx node[0];
rz(1.0*pi) node[0];
barrier node[0],node[1],node[14],node[2],node[3],node[4],node[5],node[6],node[15],node[22],node[21],node[20],node[33],node[39],node[23],node[19],node[40],node[24],node[7],node[18],node[38],node[8];
