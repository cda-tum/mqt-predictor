...
x node[3];
sx node[4];
rz(0.3665842864921134*pi) node[5];
sx node[7];
sx node[2];
rz(3.5*pi) node[3];
rz(0.5*pi) node[4];
...
ecr node[6],node[7];
sx node[2];
rz(2.366584286492113*pi) node[3];
sx node[6];
x node[7];
...
ecr node[6],node[5];
rz(0.5*pi) node[7];
rz(2.366584286492113*pi) node[0];
ecr node[2],node[3];
rz(3.5*pi) node[4];
sx node[5];
x node[6];
...
sx node[7];
rz(0.5*pi) node[7];
barrier node[0],node[3],node[2],node[7],node[4],node[6],node[5];
