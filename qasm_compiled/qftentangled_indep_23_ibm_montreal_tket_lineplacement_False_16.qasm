...
cx node[14],node[11];
cx node[13],node[12];
rz(3.6954879760742188e-06*pi) node[15];
...
sx node[4];
rz(1.0*pi) node[4];
barrier node[19],node[22],node[25],node[23],node[24],node[21],node[18],node[10],node[12],node[15],node[16],node[13],node[14],node[9],node[11],node[5],node[8],node[3],node[0],node[2],node[7],node[1],node[4];
