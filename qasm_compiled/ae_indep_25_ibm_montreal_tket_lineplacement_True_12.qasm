...
rz(0.007812499999999556*pi) node[8];
rz(0.031249999999999556*pi) node[9];
rz(7.629394530805911e-06*pi) node[10];
rz(0.015624999999999556*pi) node[11];
rz(3.814697265180911e-06*pi) node[12];
rz(1.525878906205591e-05*pi) node[13];
rz(0.062499999999999556*pi) node[14];
rz(9.536743159621608e-07*pi) node[15];
rz(0.12499999999999956*pi) node[16];
rz(1.9073486323684108e-06*pi) node[17];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[1],node[4],node[2],node[10],node[7],node[6],node[15],node[12],node[14],node[13],node[11],node[16],node[8],node[5],node[3],node[19],node[22],node[25],node[24],node[21],node[17],node[18],node[23],node[9],node[0];
