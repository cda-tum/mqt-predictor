...
rz(0.5*pi) node[0];
rx(0.5*pi) node[2];
rz(3.585937497879854*pi) node[0];
rz(0.5*pi) node[2];
rz(0.5*pi) node[0];
...
rx(0.5*pi) node[14];
rz(0.5*pi) node[0];
rz(2.1718749993916884*pi) node[2];
rz(0.5*pi) node[7];
rz(0.5*pi) node[14];
rx(0.5*pi) node[0];
rz(0.5*pi) node[2];
...
cz node[0],node[1];
rx(0.5*pi) node[13];
rz(2.6249999999999996*pi) node[0];
rz(0.5*pi) node[1];
rz(0.5*pi) node[13];
rx(0.5*pi) node[1];
cz node[14],node[13];
...
rz(0.5*pi) node[1];
rx(0.5*pi) node[13];
rz(2.0624999999999996*pi) node[1];
rz(0.5*pi) node[13];
rz(0.5*pi) node[1];
cz node[2],node[13];
rx(0.5*pi) node[1];
...
rz(0.5*pi) node[2];
rz(1.75*pi) node[2];
barrier node[7],node[0],node[13],node[3],node[2],node[1],node[14];
measure node[7] -> c[0];
measure node[0] -> c[1];
measure node[13] -> c[2];
measure node[3] -> c[3];
