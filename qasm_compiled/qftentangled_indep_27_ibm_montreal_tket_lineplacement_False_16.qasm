...
cx node[12],node[13];
cx node[23],node[21];
rz(1.9073486328125e-06*pi) node[24];
rz(0.03125*pi) node[1];
sx node[3];
rz(0.0078125*pi) node[7];
cx node[8],node[9];
...
rz(0.0009765625*pi) node[13];
cx node[21],node[18];
rz(2.86102294921875e-06*pi) node[23];
cx node[2],node[1];
...
cx node[12],node[13];
cx node[18],node[15];
rz(3.337860107421875e-06*pi) node[21];
rz(3.9375*pi) node[1];
cx node[5],node[3];
cx node[4],node[7];
cx node[8],node[9];
cx node[14],node[11];
cx node[13],node[12];
rz(3.5762786865234375e-06*pi) node[18];
cx node[2],node[1];
cx node[3],node[5];
cx node[7],node[4];
cx node[8],node[11];
...
rz(3.6954879760742188e-06*pi) node[18];
cx node[23],node[24];
rz(0.5*pi) node[3];
cx node[12],node[15];
cx node[21],node[18];
...
rz(3.7550926208496094e-06*pi) node[17];
cx node[18],node[21];
cx node[12],node[13];
rz(3.7848949432373047e-06*pi) node[18];
cx node[21],node[23];
rz(0.001953125*pi) node[13];
cx node[17],node[18];
rz(3.7997961044311523e-06*pi) node[21];
...
sx node[5];
rz(1.0*pi) node[5];
barrier node[20],node[19],node[26],node[25],node[22],node[24],node[17],node[6],node[23],node[21],node[18],node[15],node[11],node[9],node[16],node[14],node[13],node[12],node[7],node[10],node[4],node[0],node[2],node[1],node[8],node[3],node[5];
