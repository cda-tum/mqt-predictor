...
sx node[4];
cx node[0],node[14];
rz(0.49999998509883925*pi) node[4];
cx node[4],node[3];
cx node[14],node[18];
rz(3.75*pi) node[3];
cx node[18],node[19];
...
sx node[0];
rz(1.0*pi) node[0];
barrier node[23],node[18],node[19],node[40],node[20],node[21],node[22],node[8],node[41],node[42],node[43],node[34],node[24],node[25],node[26],node[16],node[7],node[6],node[15],node[5],node[4],node[3],node[2],node[14],node[1],node[0];
