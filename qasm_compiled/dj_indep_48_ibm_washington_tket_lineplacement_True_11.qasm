...
measure node[5] -> c[39];
measure node[4] -> c[40];
measure node[19] -> c[41];
measure node[3] -> c[42];
measure node[18] -> c[43];
measure node[2] -> c[44];
