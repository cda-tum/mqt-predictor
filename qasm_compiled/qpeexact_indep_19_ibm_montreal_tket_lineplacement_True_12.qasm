...
sx node[22];
sx node[24];
rz(1.5713996848905731*pi) node[25];
sx node[26];
sx node[7];
rz(0.5*pi) node[8];
rz(0.5*pi) node[11];
...
cx node[25],node[24];
cx node[25],node[22];
rz(3.5714034999933797*pi) node[24];
rz(3.8572006225926905*pi) node[22];
cx node[25],node[22];
rz(2.1428070068018403*pi) node[22];
cx node[25],node[26];
rz(3.714401245185381*pi) node[26];
cx node[25],node[26];
cx node[25],node[22];
rz(2.285614013603681*pi) node[26];
cx node[22],node[25];
cx node[25],node[22];
cx node[22],node[19];
cx node[26],node[25];
...
cx node[22],node[19];
cx node[26],node[25];
rz(1.5712280283500295*pi) node[19];
cx node[22],node[19];
cx node[19],node[22];
cx node[22],node[19];
cx node[19],node[16];
...
cx node[19],node[16];
rz(2.142456053965843*pi) node[16];
cx node[19],node[20];
rz(3.715209959197714*pi) node[20];
cx node[19],node[20];
cx node[19],node[16];
rz(2.2849121111147856*pi) node[20];
cx node[16],node[19];
cx node[19],node[16];
cx node[16],node[14];
cx node[20],node[19];
...
cx node[14],node[11];
rz(2.139648437644064*pi) node[11];
cx node[14],node[13];
cx node[8],node[11];
...
cx node[14],node[13];
cx node[8],node[11];
rz(2.278320312788129*pi) node[13];
cx node[14],node[11];
rz(0.443359373281075*pi) node[11];
cx node[14],node[11];
rz(3.056640626718925*pi) node[11];
rz(0.5*pi) node[14];
sx node[14];
rz(3.5*pi) node[14];
sx node[14];
...
cx node[11],node[14];
sx node[13];
rz(2.886718749296366*pi) node[13];
...
rz(2.5*pi) node[12];
sx node[12];
rz(1.1171875007036336*pi) node[12];
cx node[13],node[12];
cx node[12],node[13];
cx node[13],node[12];
cx node[12],node[10];
rz(1.5*pi) node[12];
sx node[12];
rz(2.2265625045903668*pi) node[12];
sx node[12];
rz(1.5*pi) node[12];
cx node[12],node[10];
sx node[10];
...
sx node[10];
sx node[12];
rz(0.23437500459036653*pi) node[10];
rz(1.4531249932652388*pi) node[12];
sx node[12];
rz(0.5*pi) node[12];
cx node[12],node[15];
sx node[12];
...
sx node[15];
cx node[12],node[10];
rz(1.4687499932652393*pi) node[15];
cx node[10],node[7];
cx node[15],node[12];
rz(0.5*pi) node[10];
cx node[12],node[15];
sx node[10];
cx node[15],node[12];
rz(1.9062499999999991*pi) node[10];
sx node[10];
rz(1.5*pi) node[10];
cx node[10],node[7];
sx node[7];
...
rz(3.5*pi) node[7];
sx node[7];
rz(1.4374999999999991*pi) node[7];
cx node[10],node[7];
cx node[7],node[10];
cx node[10],node[7];
cx node[7],node[4];
rz(1.5*pi) node[7];
sx node[7];
rz(2.187499999999999*pi) node[7];
sx node[7];
rz(1.5*pi) node[7];
cx node[7],node[4];
sx node[4];
...
rz(2.875*pi) node[4];
sx node[7];
rz(0.37499999999999956*pi) node[7];
sx node[7];
rz(2.5*pi) node[7];
cx node[7],node[6];
sx node[6];
