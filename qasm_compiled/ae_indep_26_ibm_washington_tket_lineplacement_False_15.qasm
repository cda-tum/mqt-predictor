...
sx node[40];
sx node[41];
rz(9.536743159621608e-07*pi) node[0];
rz(4.768371577590358e-07*pi) node[1];
rz(2.384185786574733e-07*pi) node[2];
rz(2.9802321943606103e-08*pi) node[3];
sx node[4];
rz(5.9604644331301415e-08*pi) node[5];
rz(6.103515624955591e-05*pi) node[6];
rz(0.0009765624999995559*pi) node[7];
rz(0.007812499999999556*pi) node[8];
rz(1.9073486323684108e-06*pi) node[14];
rz(1.1920928910669204e-07*pi) node[15];
rz(0.25*pi) node[16];
rz(3.814697265180911e-06*pi) node[18];
rz(7.629394530805911e-06*pi) node[19];
rz(1.525878906205591e-05*pi) node[20];
rz(0.00012207031249955591*pi) node[21];
rz(3.051757812455591e-05*pi) node[22];
rz(0.0004882812499995559*pi) node[23];
rz(0.003906249999999556*pi) node[24];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[1],node[2],node[0],node[3],node[4],node[6],node[7],node[8],node[5],node[14],node[15],node[22],node[20],node[33],node[23],node[21],node[24],node[34],node[25],node[19],node[26],node[43],node[38],node[39],node[40],node[18];
