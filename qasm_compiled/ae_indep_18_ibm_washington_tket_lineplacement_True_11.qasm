...
rz(0.5*pi) node[72];
rz(0.25*pi) node[81];
rz(0.062499999999999556*pi) node[82];
rz(0.031249999999999556*pi) node[83];
rz(0.12499999999999956*pi) node[84];
rz(0.007812499999999556*pi) node[92];
rz(0.015624999999999556*pi) node[101];
rz(0.003906249999999556*pi) node[102];
rz(0.0009765624999995559*pi) node[103];
rz(0.0004882812499995559*pi) node[104];
rz(0.001953124999999556*pi) node[105];
rz(0.00012207031249955591*pi) node[111];
rz(0.0002441406249995559*pi) node[121];
rz(6.103515624955591e-05*pi) node[122];
rz(3.051757812455591e-05*pi) node[123];
rz(7.629394530805911e-06*pi) node[124];
sx node[125];
rz(1.525878906205591e-05*pi) node[126];
...
cx node[72],node[81];
cx node[81],node[82];
rz(3.9201968597808445*pi) node[82];
cx node[81],node[82];
rz(0.5*pi) node[81];
rz(3.5798031402191555*pi) node[82];
sx node[81];
sx node[82];
rz(3.5*pi) node[81];
rz(3.5*pi) node[82];
...
cx node[105],node[104];
rz(6.103515625e-05*pi) node[122];
rz(7.62939453125e-06*pi) node[125];
cx node[83],node[82];
cx node[101],node[102];
rz(3.9990234375*pi) node[104];
cx node[123],node[122];
...
cx node[111],node[104];
rz(3.99993896484375*pi) node[122];
rz(3.9999923706054688*pi) node[125];
cx node[83],node[82];
cx node[101],node[102];
rz(0.00048828125*pi) node[104];
cx node[122],node[123];
...
sx node[82];
rz(1.0*pi) node[82];
barrier node[82],node[83],node[81],node[92],node[84],node[102],node[103],node[101],node[104],node[111],node[105],node[122],node[123],node[121],node[124],node[125],node[126],node[72];
