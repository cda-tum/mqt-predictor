...
rz(5*pi/2) q[22];
sx q[25];
rz(13.496698414342) q[25];
sx q[25];
rz(5*pi/2) q[25];
barrier q[3],q[10],q[2],q[7],q[12],q[14],q[22],q[19],q[25],q[0],q[1],q[6],q[13],q[9],q[15],q[18],q[24],q[21],q[8],q[4],q[11],q[5],q[17],q[16],q[20],q[26],q[23];
measure q[13] -> meas[0];
measure q[25] -> meas[1];
measure q[15] -> meas[2];
measure q[14] -> meas[3];
