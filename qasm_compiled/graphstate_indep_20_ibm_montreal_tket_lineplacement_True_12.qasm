...
sx node[12];
rz(1.5*pi) node[12];
barrier node[4],node[7],node[14],node[2],node[10],node[11],node[13],node[3],node[5],node[25],node[22],node[15],node[12],node[24],node[23],node[16],node[18],node[21],node[19],node[8];
