...
sx node[105];
rz(1.5*pi) node[105];
barrier node[125],node[110],node[126],node[92],node[79],node[99],node[100],node[111],node[83],node[112],node[108],node[103],node[91],node[98],node[101],node[82],node[102],node[104],node[97],node[86],node[87],node[81],node[80],node[107],node[105],node[123],node[124],node[122],node[84],node[85],node[121],node[120],node[119],node[93],node[106],node[118];
