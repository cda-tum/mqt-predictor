...
cx node[26],node[25];
cx node[22],node[25];
barrier node[25],node[22],node[19],node[16],node[14],node[11],node[8],node[9],node[26],node[13],node[12],node[10],node[7],node[6],node[15],node[4],node[1],node[0],node[24],node[2],node[3],node[5],node[20];
