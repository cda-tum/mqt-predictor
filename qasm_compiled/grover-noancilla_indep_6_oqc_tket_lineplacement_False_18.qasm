...
sx node[0];
ecr node[7],node[0];
rz(0.062500000000001*pi) node[0];
rz(0.5*pi) node[7];
sx node[0];
sx node[7];
rz(2.5*pi) node[0];
...
ecr node[0],node[1];
rz(0.5*pi) node[0];
rz(0.062500000000001*pi) node[1];
sx node[0];
sx node[1];
rz(3.5*pi) node[0];
rz(2.5*pi) node[1];
...
ecr node[1],node[2];
rz(0.5*pi) node[1];
rz(0.062500000000001*pi) node[2];
sx node[1];
sx node[2];
rz(3.5*pi) node[1];
rz(2.5*pi) node[2];
...
ecr node[2],node[3];
rz(0.5*pi) node[2];
rz(2.062500000000001*pi) node[3];
sx node[2];
sx node[3];
rz(3.5*pi) node[2];
rz(2.5*pi) node[3];
...
rz(1.0*pi) node[2];
rz(1.0*pi) node[3];
barrier node[1],node[4],node[2],node[0],node[3],node[7];
