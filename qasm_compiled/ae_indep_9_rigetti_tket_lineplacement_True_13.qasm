...
rz(3.6249999999999996*pi) node[26];
rz(3.5624999999999996*pi) node[35];
rz(3.5078124999999996*pi) node[36];
rz(3.5312499999999996*pi) node[37];
rz(3.75*pi) node[38];
rz(0.5*pi) node[64];
rz(0.5*pi) node[65];
rz(3.5156249999999996*pi) node[72];
rz(3.5039062499999996*pi) node[78];
rz(0.5*pi) node[79];
rz(0.5*pi) node[79];
rx(0.5*pi) node[79];
rz(0.5*pi) node[79];
...
rz(0.5*pi) node[37];
rz(3.5*pi) node[37];
rx(2.2185932143772433*pi) node[37];
rz(0.5*pi) node[37];
rz(0.5*pi) node[37];
rx(0.5*pi) node[37];
rz(0.5*pi) node[37];
...
rz(3.5*pi) node[37];
rz(0.5*pi) node[26];
rx(3.7814067856227562*pi) node[37];
rz(0.5*pi) node[37];
rz(0.5*pi) node[37];
rx(0.5*pi) node[37];
rz(0.5*pi) node[37];
...
rz(0.5*pi) node[26];
rz(1.75*pi) node[26];
barrier node[27],node[26],node[64],node[37],node[36],node[79],node[35],node[72],node[38];
