...
sx node[98];
rz(1.5*pi) node[98];
barrier node[108],node[81],node[121],node[123],node[118],node[120],node[84],node[100],node[82],node[92],node[85],node[83],node[87],node[101],node[110],node[103],node[104],node[106],node[86],node[112],node[126],node[124],node[122],node[125],node[99],node[102],node[119],node[98],node[105],node[93],node[107],node[111];
