...
sx node[10];
rz(1.5*pi) node[10];
barrier node[5],node[0],node[4],node[6],node[9],node[2],node[13],node[14],node[12],node[11],node[21],node[18],node[22],node[25],node[17],node[1],node[15],node[8],node[16],node[7],node[10],node[19],node[3];
