...
rz(1.9073486323684108e-06*pi) node[1];
rz(9.536743159621608e-07*pi) node[2];
rz(1.1920928910669204e-07*pi) node[3];
sx node[4];
rz(2.384185786574733e-07*pi) node[5];
rz(0.0002441406249995559*pi) node[6];
rz(0.003906249999999556*pi) node[7];
rz(0.031249999999999556*pi) node[8];
rz(7.629394530805911e-06*pi) node[14];
...
rz(0.00012207031249955591*pi) node[22];
rz(0.001953124999999556*pi) node[23];
rz(0.015624999999999556*pi) node[24];
rz(0.25*pi) node[25];
...
sx node[18];
rz(1.0*pi) node[18];
barrier node[18],node[14],node[19],node[0],node[1],node[2],node[3],node[15],node[5],node[22],node[23],node[21],node[24],node[25],node[20],node[33],node[26],node[16],node[34],node[39],node[6],node[43],node[38],node[4];
