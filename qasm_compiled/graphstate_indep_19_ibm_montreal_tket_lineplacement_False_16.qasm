...
sx node[7];
rz(1.5*pi) node[7];
barrier node[2],node[3],node[6],node[12],node[14],node[13],node[4],node[11],node[16],node[8],node[19],node[0],node[5],node[17],node[10],node[15],node[1],node[18],node[7];
