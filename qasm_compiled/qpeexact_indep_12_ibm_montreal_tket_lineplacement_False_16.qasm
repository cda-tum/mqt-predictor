...
sx node[7];
rz(0.5*pi) node[8];
rz(3.352416382349567*pi) node[10];
cx node[1],node[0];
sx node[10];
rz(0.4287109433048286*pi) node[0];
rz(0.5*pi) node[10];
cx node[1],node[0];
rz(3.571777337945171*pi) node[0];
cx node[1],node[2];
rz(3.8574218750199285*pi) node[2];
cx node[1],node[2];
cx node[1],node[4];
rz(2.143554687480071*pi) node[2];
cx node[3],node[2];
rz(3.714843743673659*pi) node[4];
cx node[1],node[4];
cx node[2],node[3];
cx node[3],node[2];
rz(2.2871093813263403*pi) node[4];
cx node[1],node[2];
cx node[5],node[3];
cx node[7],node[4];
...
cx node[10],node[7];
cx node[3],node[2];
rz(2.148437499391689*pi) node[4];
cx node[12],node[10];
cx node[1],node[2];
cx node[5],node[3];
cx node[7],node[4];
...
rz(0.2968749999999998*pi) node[2];
cx node[6],node[7];
cx node[12],node[13];
sx node[1];
cx node[3],node[2];
...
sx node[4];
rz(1.5*pi) node[1];
rz(0.9461663823495658*pi) node[4];
cx node[7],node[4];
cx node[4],node[7];
cx node[7],node[4];
cx node[1],node[4];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[8],node[6],node[5],node[3],node[12],node[10],node[7],node[0],node[4],node[2],node[1],node[11];
measure node[8] -> c[0];
measure node[6] -> c[1];
measure node[5] -> c[2];
measure node[3] -> c[3];
