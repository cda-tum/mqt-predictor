...
sx node[14];
rz(1.0*pi) node[14];
barrier node[16],node[8],node[7],node[26],node[25],node[24],node[33],node[19],node[20],node[21],node[23],node[22],node[6],node[5],node[15],node[4],node[3],node[2],node[1],node[18],node[0],node[14];
