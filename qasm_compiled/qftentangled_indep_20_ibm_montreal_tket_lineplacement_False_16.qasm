...
sx node[3];
rz(1.0*pi) node[3];
barrier node[22],node[25],node[23],node[24],node[19],node[12],node[16],node[9],node[8],node[11],node[14],node[13],node[10],node[7],node[0],node[4],node[1],node[5],node[2],node[3];
