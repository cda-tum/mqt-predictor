...
sx node[25];
cx node[24],node[23];
rz(0.49999994039535567*pi) node[25];
cx node[23],node[24];
cx node[24],node[23];
cx node[23],node[21];
cx node[25],node[24];
...
sx node[24];
rz(1.0*pi) node[24];
barrier node[22],node[9],node[19],node[16],node[14],node[11],node[8],node[5],node[3],node[0],node[2],node[1],node[6],node[4],node[7],node[13],node[10],node[12],node[17],node[15],node[18],node[21],node[25],node[23],node[24];
