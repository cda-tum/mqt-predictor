...
sx node[12];
rz(1.5*pi) node[12];
barrier node[1],node[2],node[10],node[7],node[4],node[19],node[22],node[23],node[24],node[25],node[5],node[8],node[3],node[21],node[18],node[15],node[13],node[12],node[16],node[11],node[14];
