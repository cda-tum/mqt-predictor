...
sx node[2];
rz(1.0*pi) node[2];
barrier node[24],node[8],node[25],node[26],node[16],node[7],node[6],node[5],node[4],node[15],node[22],node[21],node[20],node[19],node[18],node[14],node[0],node[3],node[1],node[2];
