...
rz(5.9604644331301415e-08*pi) node[4];
...
rz(3.051757812455591e-05*pi) node[9];
rz(9.536743159621608e-07*pi) node[10];
rz(1.525878906205591e-05*pi) node[11];
...
rz(0.015624999999999556*pi) node[23];
...
sx node[5];
rz(1.0*pi) node[5];
barrier node[5],node[8],node[3],node[11],node[14],node[10],node[15],node[7],node[12],node[25],node[24],node[23],node[22],node[21],node[19],node[16],node[13],node[2],node[18],node[4],node[9],node[6],node[17],node[26],node[20],node[0],node[1];
