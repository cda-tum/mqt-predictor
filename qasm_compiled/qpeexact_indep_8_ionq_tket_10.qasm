...
rz(3.0*pi) q[2];
rz(3.5*pi) psi[0];
rx(3.1914838457624053*pi) q[2];
rx(3.8280521685042617*pi) psi[0];
rz(1.0*pi) q[2];
rz(1.0*pi) psi[0];
ry(0.5*pi) q[2];
ry(0.5*pi) psi[0];
