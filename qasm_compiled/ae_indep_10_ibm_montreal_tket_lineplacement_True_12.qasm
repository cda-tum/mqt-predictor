...
sx node[25];
rz(0.25*pi) node[10];
rz(0.12499999999999956*pi) node[12];
rz(0.5*pi) node[13];
...
cx node[13],node[12];
rz(0.43718642875448666*pi) node[12];
cx node[13],node[12];
rz(3.0628135712455133*pi) node[12];
rz(0.5*pi) node[13];
sx node[12];
sx node[13];
rz(3.5*pi) node[12];
...
sx node[12];
rz(1.0*pi) node[12];
barrier node[12],node[15],node[10],node[18],node[21],node[17],node[23],node[24],node[25],node[13];
