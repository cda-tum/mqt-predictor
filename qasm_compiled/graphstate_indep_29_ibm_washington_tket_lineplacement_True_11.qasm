...
sx node[105];
rz(1.5*pi) node[105];
barrier node[87],node[86],node[102],node[108],node[123],node[124],node[85],node[84],node[93],node[111],node[122],node[104],node[105],node[103],node[125],node[119],node[120],node[126],node[112],node[121],node[106],node[83],node[100],node[101],node[107],node[118],node[110],node[99],node[92];
