...
rz(0.5*pi) node[2];
rz(0.5*pi) node[1];
barrier node[77],node[79],node[78],node[65],node[66],node[64],node[71],node[29],node[70],node[27],node[28],node[26],node[36],node[31],node[32],node[24],node[39],node[25],node[37],node[38],node[30],node[23],node[20],node[16],node[56],node[17],node[19],node[18],node[22],node[21],node[15],node[12],node[8],node[48],node[9],node[11],node[10],node[14],node[13],node[5],node[4],node[6],node[47],node[7],node[41],node[40],node[0],node[3],node[2],node[1];
measure node[77] -> c[0];
measure node[79] -> c[1];
measure node[78] -> c[2];
measure node[65] -> c[3];
