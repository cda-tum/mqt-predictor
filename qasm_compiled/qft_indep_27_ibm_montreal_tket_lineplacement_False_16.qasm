...
creg meas[27];
sx node[1];
rz(2.86102294921875e-06*pi) node[17];
rz(3.337860107421875e-06*pi) node[19];
rz(3.6954879760742188e-06*pi) node[20];
rz(1.9073486328125e-06*pi) node[21];
rz(3.5762786865234375e-06*pi) node[22];
rz(3.807246685028076e-06*pi) node[23];
rz(3.7848949432373047e-06*pi) node[24];
rz(3.7550926208496094e-06*pi) node[25];
rz(3.7997961044311523e-06*pi) node[26];
rz(0.5*pi) node[1];
sx node[1];
...
cx node[8],node[11];
rz(3.9375*pi) node[2];
rz(0.49999994039535567*pi) node[4];
rz(0.015625*pi) node[5];
cx node[8],node[9];
...
rz(3.9375*pi) node[2];
rz(0.49999976158142134*pi) node[4];
...
rz(3.9375*pi) node[2];
cx node[3],node[5];
rz(0.49999904632568404*pi) node[4];
cx node[7],node[10];
cx node[9],node[8];
cx node[11],node[14];
cx node[15],node[12];
...
cx node[12],node[15];
rz(3.984375*pi) node[2];
rz(0.4999961853027348*pi) node[4];
cx node[7],node[10];
cx node[15],node[12];
cx node[3],node[2];
cx node[6],node[7];
...
sx node[2];
rz(1.0*pi) node[2];
barrier node[9],node[21],node[17],node[0],node[23],node[26],node[5],node[20],node[24],node[25],node[22],node[19],node[8],node[18],node[15],node[16],node[11],node[14],node[13],node[12],node[6],node[10],node[7],node[4],node[3],node[1],node[2];
