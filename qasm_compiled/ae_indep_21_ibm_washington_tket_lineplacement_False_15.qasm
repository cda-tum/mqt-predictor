...
sx node[39];
sx node[40];
rz(3.051757812455591e-05*pi) node[0];
rz(1.525878906205591e-05*pi) node[1];
rz(7.629394530805911e-06*pi) node[2];
rz(9.536743159621608e-07*pi) node[3];
sx node[4];
rz(1.9073486323684108e-06*pi) node[5];
rz(0.001953124999999556*pi) node[6];
...
rz(0.0009765624999995559*pi) node[22];
...
cx node[0],node[1];
rz(0.5*pi) node[0];
rz(0.1409716008347459*pi) node[1];
sx node[0];
sx node[1];
rz(3.5*pi) node[0];
rz(3.5*pi) node[1];
...
sx node[1];
rz(1.0*pi) node[1];
barrier node[1],node[0],node[2],node[14],node[3],node[4],node[5],node[22],node[15],node[19],node[18],node[33],node[39],node[20],node[21],node[6],node[23],node[24],node[8],node[7],node[40];
