...
sx node[6];
rz(0.5*pi) node[7];
rz(2.8816405685007194*pi) node[0];
sx node[1];
sx node[2];
sx node[3];
sx node[4];
...
rz(1.0264727806036038*pi) node[7];
rz(3.5*pi) node[0];
sx node[1];
sx node[2];
sx node[3];
...
sx node[1];
ecr node[2],node[3];
rz(2.6849479253232102*pi) node[4];
rz(3.5*pi) node[5];
rz(3.5*pi) node[0];
sx node[2];
x node[3];
...
x node[3];
sx node[4];
rz(1.1296252914548852*pi) node[7];
ecr node[1],node[2];
rz(3.5*pi) node[3];
ecr node[5],node[4];
x node[7];
...
x node[4];
x node[7];
rz(3.0447842046791136*pi) node[0];
ecr node[2],node[1];
rz(3.5*pi) node[4];
rz(3.5*pi) node[7];
sx node[0];
...
sx node[5];
rz(3.5*pi) node[4];
rz(2.7161793402759677*pi) node[5];
ecr node[4],node[3];
sx node[5];
x node[3];
sx node[4];
